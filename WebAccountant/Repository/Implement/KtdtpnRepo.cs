...
{
    public class KtdtpnRepo : IKtdtpnsRepo
    {
        private readonly UnitOfWork _unitOfWork;
        public KtdtpnRepo(UnitOfWork unitOfWork)
        {
            _unitOfWork = unitOfWork;
        }
        public async Task<EntityEntry<Ktdtpn>> AddNew(Ktdtpn entity)
        {
            var result = await _unitOfWork.KTDTPNDAO.Add(entity);
        ...
        public async Task Delete(string key)
        {
            ...
            await _unitOfWork.KTDTPNDAO.RemoveEntity(model);
            await _unitOfWork.SaveChangesAsync();
        }

        public async Task<IEnumerable<Ktdtpn>> GetAllAsync()
        {
            return await _unitOfWork.KTDTPNDAO.GetAll();
        }
