...
namespace WebAccountant.ModelsBase
{
    public partial class Ktdm
    {
        ...
        public double Dgban2 { get; set; }
        public double Dgban3 { get; set; }
        public double Dgban4 { get; set; }
        public string? Donvi1 { get; set; }
        public string? Donvi2 { get; set; }
        public string? Donvi3 { get; set; }
        public double Hsqd1 { get; set; }
        public double Hsqd2 { get; set; }
        public double Hsqd3 { get; set; }
        public double UsdtonT { get; set; }
        public double UsdnhapT { get; set; }
        public double UsdxuatT { get; set; }
        public double UsdtonCk { get; set; }
        public double Dgusd { get; set; }
        public double Dgnhap1 { get; set; }
        public double Dgnhap2 { get; set; }
        public double Dgnhap3 { get; set; }
        public double Dgnhap4 { get; set; }
        public double Dgnhap5 { get; set; }
        public double? Trangthai { get; set; }
        public double Dgnhap { get; set; }
        public double DgChuyenkho { get; set; }
        public string? DgCktm { get; set; }
        public double DgVc { get; set; }
        public string? DmCktm { get; set; }
        public double Gioihanton { get; set; }
        ...
        public double TyleOfNhom { get; set; }
        public double NhapTDv1 { get; set; }
        public double NhapTDv2 { get; set; }
        public double TonCkDv1 { get; set; }
        public double TonCkDv2 { get; set; }
        public double TonTDv1 { get; set; }
        public double TonTDv2 { get; set; }
        public double XuatTDv1 { get; set; }
        public double XuatTDv2 { get; set; }
        public string? Nhomck { get; set; }
        public string? Makho { get; set; }
        public string? Mavach { get; set; }
        public double GioihantonMax { get; set; }
        public string? IdUpdate { get; set; }
        public string? Tendm2 { get; set; }
        public double DgbanGanNhat { get; set; }
        public double DgmuaGanNhat { get; set; }
        public string? Ghichu { get; set; }
        public DateTime? NgaybanGanNhat { get; set; }
        public DateTime? NgaymuaGanNhat { get; set; }
        public string? Quycach { get; set; }
        public double Songaysudung { get; set; }
    }
}
